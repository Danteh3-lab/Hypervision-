...
package hypervision.gradle.util;
        ...
        try (
            ...
            for (JarEntry entry : entries) {
                ...
                if (entry.getName().endsWith(".refmap.json")) {
                    ...
                    if (!manifest.contains("hypervision.launch.tweaker.HypervisionTweaker")) {
                        throw new IllegalStateException("unable to replace");
                    }
                    manifest = manifest.replace("hypervision.launch.tweaker.HypervisionTweaker", "org.spongepowered.asm.launch.MixinTweaker");
