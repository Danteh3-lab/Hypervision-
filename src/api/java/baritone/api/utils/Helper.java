...
public interface Helper {
    ...
    static Component getPrefix() {
        ...
        MutableComponent baritone = Component.literal(xd ? "Hypervisin" : BaritoneAPI.getSettings().shortBaritonePrefix.value ? "H" : "Hypervision");
        baritone.setStyle(baritone.getStyle().withColor(ChatFormatting.RED));

        // Outer brackets
        MutableComponent prefix = Component.literal("");
        prefix.setStyle(baritone.getStyle().withColor(ChatFormatting.DARK_GRAY));
        prefix.append("[");
