...
public final class Settings {
     ...
     */
    public final Setting<Color> colorBestPathSoFar = new Setting<>(new Color(0x4B5563));

    /**
     * The color of the path to the most recent considered node
     */
    public final Setting<Color> colorMostRecentConsidered = new Setting<>(new Color(0xD1D5DB));

    /**
     * The color of the goal box
     */
    public final Setting<Color> colorGoalBox = new Setting<>(new Color(0xD1D5DB));

    /**
     * The color of the goal box when it's inverted
     */
    public final Setting<Color> colorInvertedGoalBox = new Setting<>(new Color(0xC62828));

    /**
     * The color of all selections
     */
    public final Setting<Color> colorSelection = new Setting<>(new Color(0x4B5563));

    /**
     * The color of the selection pos 1
     */
    public final Setting<Color> colorSelectionPos1 = new Setting<>(new Color(0x374151));

    /**
     * The color of the selection pos 2
     */
    public final Setting<Color> colorSelectionPos2 = new Setting<>(new Color(0xD1D5DB));
