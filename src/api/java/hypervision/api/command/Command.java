...
package hypervision.api.command;
...
public abstract class Command implements ICommand {
    ...
    protected IBaritone hypervision;
    ...
    /**
     * Creates a new Hypervision control command.
     *
     * @param names The names of this command. This is what you put after the command prefix.
     */
    protected Command(IBaritone hypervision, String... names) {
