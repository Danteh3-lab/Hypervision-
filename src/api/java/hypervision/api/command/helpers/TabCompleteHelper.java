...
package hypervision.api.command.helpers;
...
public class TabCompleteHelper {
    ...
    public TabCompleteHelper addSettings() {
        return append(
                HypervisionAPI.getSettings().allSettings.stream()
    ...
    public TabCompleteHelper addModifiedSettings() {
        return append(
                SettingsUtil.modifiedSettings(HypervisionAPI.getSettings()).stream()
                        .map(Settings.Setting::getName)
                        .sorted(String.CASE_INSENSITIVE_ORDER)
        );
    }
    ...
    public TabCompleteHelper addToggleableSettings() {
        return append(
                HypervisionAPI.getSettings().getAllValuesByType(Boolean.class).stream()
                        .map(Settings.Setting::getName)
                        .sorted(String.CASE_INSENSITIVE_ORDER)
        );
    }
