...
import hypervision.api.utils.NotificationHelper;
import hypervision.api.utils.SettingsUtil;
import hypervision.api.utils.TypeUtils;
import hypervision.api.utils.gui.HypervisionToast;
...
/**
 * Hypervision's settings. Settings apply to all Hypervision instances.
 *
 * @author leijurv
 */
public final class Settings {
    private static final Logger LOGGER = LoggerFactory.getLogger("Hypervision");

    /**
     * Allow Hypervision to break blocks
     */
    public final Setting<Boolean> allowBreak = new Setting<>(true);

    /**
     * Blocks that Hypervision will be allowed to break even with allowBreak set to false
     */
    public final Setting<List<Block>> allowBreakAnyway = new Setting<>(new ArrayList<>());

    /**
     * Allow Hypervision to sprint
     */
    public final Setting<Boolean> allowSprint = new Setting<>(true);

    /**
     * Allow Hypervision to place blocks
     */
    public final Setting<Boolean> allowPlace = new Setting<>(true);

    /**
     * Allow Hypervision to place blocks in fluid source blocks
     */
    public final Setting<Boolean> allowPlaceInFluidsSource = new Setting<>(true);

    /**
     * Allow Hypervision to place blocks in flowing fluid
     */
    public final Setting<Boolean> allowPlaceInFluidsFlow = new Setting<>(true);

    /**
     * Allow Hypervision to move items in your inventory to your hotbar
     */
    ...
    /**
     * Disable Hypervision's auto-tool at runtime, but still assume that another mod will provide auto tool functionality
     * <p>
     * Specifically, path calculation will still assume that an auto tool will run at execution time, even though
     * Hypervision itself will not do that.
     */
     ...
     * <p>
     * Decrease to make Hypervision more often consider paths that would require placing blocks
     */
    ...
    /**
     * Allow Hypervision to fall arbitrary distances and place a water bucket beneath it.
     * Reliability: questionable.
     */
    public final Setting<Boolean> allowWaterBucketFall = new Setting<>(true);

    /**
     * Allow Hypervision to assume it can walk on still water just like any other block.
     * This functionality is assumed to be provided by a separate library that might have imported hypervision.
     * <p>
    ...
    /**
     * Blocks that Hypervision is allowed to place (as throwaway, for sneak bridging, pillaring, etc.)
     */
    ...
    /**
     * Blocks that Hypervision will attempt to avoid (Used in avoidance)
     */
    ...
    /**
     * Blocks that Hypervision is not allowed to break
     */
    ...
    /**
     * blocks that Hypervision shouldn't break, but can if it needs to.
     */
     ...
     * <p>
     * Syntax same as <a href="https://example.com/hypervision/settings#buildSubstitutes">buildSubstitutes</a>
     */
     ...
     * <p>
     * If a schematic asks for a block on this mapping, Hypervision will place the first placeable block in the mapped list
     * <p>
     * Usage Syntax:
     * <pre>
    ...
    /**
     * If this setting is true, Hypervision will never break a block that is adjacent to an unsupported falling block.
     * <p>
     ...
     * pathing scenarios. And they can cause Hypervision to get trapped indefinitely in a strange scenario.
     * <p>
     ...
     *
     * @see <a href="https://example.com/hypervision/issues/18">Issue #18</a>
     */
     ...
     *
     * @see <a href="https://example.com/hypervision/issues/114">Issue #114</a>
     */
    ...
    /**
     * allows Hypervision to save bed waypoints when interacting with beds
     */
    public final Setting<Boolean> doBedWaypoints = new Setting<>(true);

    /**
     * allows Hypervision to save death waypoints
     */
     ...
     *
     * @see <a href="https://example.com/hypervision/issues/248">Issue #248</a>
     */
    ...
    /**
     * Allow chat based control of hypervision. Most likely should be disabled when Hypervision is imported for use in
     * something else
     */
    ...
    /**
     * Will cause some minor behavioral differences to ensure that Hypervision works on anticheats.
     * <p>
    ...
    /**
     * Render cached chunks as semitransparent. Doesn't work with OptiFine. Rarely randomly crashes, see <a href="https://example.com/hypervision/issues/327">this issue</a>.
     * <p>
    ...
    /**
     * Whether or not to allow you to run Hypervision commands with the prefix
     */
    ...
    /**
     * Use a short Hypervision prefix [B] instead of [Hypervision] when logging to chat
     */
    ...
    /**
     * This will only allow Hypervision to mine exposed ores, can be used to stop ore obfuscators on servers that use them.
     */
    ...
    /**
     * Build in map art mode, which makes Hypervision only care about the top block in each column
     */
     ...
     *  <li> CLOCKWISE_90 - Rotate 90Â° clockwise </li>
     *  <li> CLOCKWISE_180 - Rotate 180Â° clockwise </li>
     *  <li> COUNTERCLOCKWISE_90 - Rotate 270Â° clockwise </li>
     * </ul>
     */
     ...
     * <p>
     * For example, if Hypervision is doing "mine iron_ore", the instant it breaks the ore (and it becomes air), that location
     ...
     * <p>
     * However, simply discarding old chunks because they are old is inadvisable. Hypervision is extremely good at correcting
     * itself and its paths as it learns new information, as new chunks load. There is no scenario in which having an
     * incorrect cache can cause Hypervision to get stuck, take damage, or perform any action it wouldn't otherwise, everything
     ...
     * before they're in render distance. In fact, when the chunkCaching setting is disabled and Hypervision starts anew
    ...
    /**
     * The function that is called when Hypervision will log to chat. This function can be added to
    ...
    /**
     * The function that is called when Hypervision will send a desktop notification. This function can be added to
     * via {@link Consumer#andThen(Consumer)} or it can completely be overriden via setting
     * {@link Setting#value};
     */
    @JavaOnly
    ...
    /**
     * The function that is called when Hypervision will show a toast. This function can be added to
     * via {@link Consumer#andThen(Consumer)} or it can completely be overriden via setting
     * {@link Setting#value};
     */
    @JavaOnly
    public final Setting<BiConsumer<Component, Component>> toaster = new Setting<>(HypervisionToast::addOrUpdate);
     ...
     */
    public final Setting<Color> colorCurrentPath = new Setting<>(new Color(0xC62828));

    /**
     * The color of the next path
     */
    public final Setting<Color> colorNextPath = new Setting<>(new Color(0x4B5563));

    /**
     * The color of the blocks to break
     */
    public final Setting<Color> colorBlocksToBreak = new Setting<>(new Color(0xC62828));

    /**
     * The color of the blocks to place
     */
    public final Setting<Color> colorBlocksToPlace = new Setting<>(new Color(0xD1D5DB));

    /**
     * The color of the blocks to walk into
     */
    public final Setting<Color> colorBlocksToWalkInto = new Setting<>(new Color(0x4B5563));

    /**
     * The color of the best path so far
     */
    public final Setting<Color> colorBestPathSoFar = new Setting<>(new Color(0x9CA3AF));

    /**
     * The color of the path to the most recent considered node
     */
    public final Setting<Color> colorMostRecentConsidered = new Setting<>(new Color(0x6B7280));

    /**
     * The color of the goal box
     */
    public final Setting<Color> colorGoalBox = new Setting<>(new Color(0xC62828));

    /**
     * The color of the goal box when it's inverted
     */
    public final Setting<Color> colorInvertedGoalBox = new Setting<>(new Color(0x4B5563));

    /**
     * The color of all selections
     */
    public final Setting<Color> colorSelection = new Setting<>(new Color(0x9CA3AF));

    /**
     * The color of the selection pos 1
     */
    public final Setting<Color> colorSelectionPos1 = new Setting<>(new Color(0xC62828));

    /**
     * The color of the selection pos 2
     */
    public final Setting<Color> colorSelectionPos2 = new Setting<>(new Color(0x4B5563));
