...
import hypervision.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a Hypervision process and a behavior:
 * <ul>
 * <li>Only one Hypervision process can be active at a time</li>
...
public interface IBaritoneProcess {
    ...
    /**
     * Called when this process is in control of pathing; Returns what Hypervision should do.
     *
