...
public final class LookBehavior extends Behavior implements ILookBehavior {
    ...
    private static abstract class AbstractAimProcessor implements ITickableAimProcessor {
        ...
        public final void tick() {
            // randomLooking
            this.randomYawOffset = (this.rand.nextDouble() - 0.5) * hypervision.settings().randomLooking.value;
            this.randomPitchOffset = (this.rand.nextDouble() - 0.5) * hypervision.settings().randomLooking.value;
            ...
            this.randomYawOffset += random * hypervision.settings().randomLooking113.value;
        }
