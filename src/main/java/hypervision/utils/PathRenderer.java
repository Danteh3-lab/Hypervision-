...
public final class PathRenderer implements IRenderer {
    ...
    public static void render(RenderEvent event, PathingBehavior behavior) {
        ...
        final DimensionType currentRenderViewDimension = HypervisionAPI.getProvider().getPrimaryBaritone().getPlayerContext().world().dimensionType();
    ...
    public static void drawManySelectionBoxes(PoseStack stack, Entity player, Collection<BlockPos> positions, Color color) {
        ...
        BlockStateInterface bsi = new BlockStateInterface(HypervisionAPI.getProvider().getPrimaryBaritone().getPlayerContext()); // TODO this assumes same dimension between primary Hypervision and render view? is this safe?
