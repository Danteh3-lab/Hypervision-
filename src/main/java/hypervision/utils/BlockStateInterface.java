...
import hypervision.cache.CachedRegion;
import hypervision.cache.WorldData;
import hypervision.utils.accessor.IClientChunkProvider;
...
public class BlockStateInterface {
    ...
    public BlockStateInterface(IPlayerContext ctx, boolean copyLoadedChunks) {
        ...
        this.useTheRealWorld = !hypervision.settings().pathThroughCachedOnly.value;
