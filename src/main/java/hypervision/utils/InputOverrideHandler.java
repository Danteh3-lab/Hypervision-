...
import hypervision.api.utils.IInputOverrideHandler;
...
public final class InputOverrideHandler extends Behavior implements IInputOverrideHandler {
    ...
    public InputOverrideHandler(Hypervision hypervision) {
        super(hypervision);
        this.blockBreakHelper = new BlockBreakHelper(hypervision.getPlayerContext());
        this.blockPlaceHelper = new BlockPlaceHelper(hypervision.getPlayerContext());
    }
    ...
    private boolean inControl() {
        ...
        return hypervision.getPathingBehavior().isPathing() || hypervision != HypervisionAPI.getProvider().getPrimaryBaritone();
    }
