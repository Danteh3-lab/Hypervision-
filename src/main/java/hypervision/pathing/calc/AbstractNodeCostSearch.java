...
import hypervision.api.pathing.calc.IPathFinder;
...
public abstract class AbstractNodeCostSearch implements IPathFinder, Helper {
    ...
    /**
     * @see <a href="https://example.com/hypervision/issues/107">Issue #107</a>
     */
    ...
    AbstractNodeCostSearch(BetterBlockPos realStart, int startX, int startY, int startZ, Goal goal, CalculationContext context) {
        ...
        this.map = new Long2ObjectOpenHashMap<>(hypervision.settings().pathingMapDefaultSize.value, hypervision.settings().pathingMapLoadFactor.value);
    }
