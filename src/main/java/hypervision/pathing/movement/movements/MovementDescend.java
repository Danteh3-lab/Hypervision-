...
public class MovementDescend extends Movement {
    ...
    public MovementDescend(IBaritone hypervision, BetterBlockPos start, BetterBlockPos end) {
        super(hypervision, start, end, new BetterBlockPos[]{end.above(2), end.above(), end}, end.below());
    }
    ...
    public MovementState updateState(MovementState state) {
        ...
        state.setInput(Input.SNEAK, hypervision.settings().allowWalkOnMagmaBlocks.value && ctx.world().getBlockState(ctx.player().blockPosition().below()).is(Blocks.MAGMA_BLOCK));
