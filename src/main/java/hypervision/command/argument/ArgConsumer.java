...
package hypervision.command.argument;
...
import hypervision.api.command.datatypes.IDatatype;
import hypervision.api.command.datatypes.IDatatypeContext;
import hypervision.api.command.datatypes.IDatatypeFor;
import hypervision.api.command.datatypes.IDatatypePost;
...
import hypervision.api.command.exception.CommandTooManyArgumentsException;
...
public class ArgConsumer implements IArgConsumer {
    ...
    public <T, O, D extends IDatatypePost<T, O>> T getDatatypePost(D datatype, O original) throws CommandInvalidTypeException, CommandNotEnoughArgumentsException {
        try {
            ...
            if (hypervision.settings().verboseCommandExceptions.value) {
                e.printStackTrace();
            }
