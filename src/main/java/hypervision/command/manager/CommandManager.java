...
package hypervision.command.manager;
...
import hypervision.api.command.exception.CommandUnhandledException;
import hypervision.api.command.exception.ICommandException;
...
import hypervision.command.defaults.DefaultCommands;
...
public class CommandManager implements ICommandManager {
    ...
    public CommandManager(Hypervision hypervision) {
        this.hypervision = hypervision;
        DefaultCommands.createAll(hypervision).forEach(this.registry::register);
    }

    @Override
    public IBaritone getBaritone() {
        return this.hypervision;
    }
