...
import hypervision.api.command.exception.CommandNotEnoughArgumentsException;
...
import hypervision.api.command.manager.ICommandManager;
import hypervision.api.event.events.ChatEvent;
import hypervision.api.event.events.TabCompleteEvent;
import hypervision.api.utils.Helper;
import hypervision.api.utils.SettingsUtil;
import hypervision.behavior.Behavior;
import hypervision.command.argument.ArgConsumer;
import hypervision.command.argument.CommandArguments;
import hypervision.command.manager.CommandManager;
import hypervision.utils.accessor.IGuiScreen;
...
public class ExampleBaritoneControl extends Behavior implements Helper {
    ...
    private static final Settings settings = HypervisionAPI.getSettings();
    private final ICommandManager manager;

    public ExampleBaritoneControl(Hypervision hypervision) {
        super(hypervision);
        this.manager = hypervision.getCommandManager();
    }
