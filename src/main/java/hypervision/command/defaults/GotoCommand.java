...
import hypervision.api.command.datatypes.RelativeCoordinate;
import hypervision.api.command.datatypes.RelativeGoal;
...
public class GotoCommand extends Command {
    ...
    protected GotoCommand(IBaritone hypervision) {
        super(hypervision, "goto");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        hypervision.getGetToBlockProcess().getToBlock(destination);
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The goto command tells hypervision to head towards a given goal or block.",
                "",
