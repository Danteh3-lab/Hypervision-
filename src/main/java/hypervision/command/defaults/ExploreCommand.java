...
import hypervision.api.command.datatypes.RelativeGoalXZ;
...
public class ExploreCommand extends Command {
    ...
    public ExploreCommand(IBaritone hypervision) {
        super(hypervision, "explore");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        hypervision.getExploreProcess().explore(goal.getX(), goal.getZ());
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "Tell hypervision to explore randomly. If you used explorefilter before this, it will be applied.",
                "",
                "Usage:",
