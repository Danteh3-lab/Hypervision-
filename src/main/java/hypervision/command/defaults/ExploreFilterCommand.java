...
public class ExploreFilterCommand extends Command {
    ...
    public ExploreFilterCommand(IBaritone hypervision) {
        super(hypervision, "explorefilter");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        try {
            hypervision.getExploreProcess().applyJsonFilter(file.toPath().toAbsolutePath(), invert);
