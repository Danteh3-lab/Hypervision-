...
public class GoalCommand extends Command {
    ...
    public GoalCommand(IBaritone hypervision) {
        super(hypervision, "goal");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        ICustomGoalProcess goalProcess = hypervision.getCustomGoalProcess();
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The goal command allows you to set or clear hypervision's goal.",
                "",
