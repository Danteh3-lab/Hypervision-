...
import hypervision.api.pathing.goals.GoalInverted;
...
public class InvertCommand extends Command {
    ...
    public InvertCommand(IBaritone hypervision) {
        super(hypervision, "invert");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        ICustomGoalProcess customGoalProcess = hypervision.getCustomGoalProcess();
        Goal goal;
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The invert command tells hypervision to head away from the current goal rather than towards it.",
                "",
                "Usage:",
