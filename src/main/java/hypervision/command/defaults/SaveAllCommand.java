...
public class SaveAllCommand extends Command {
    ...
    public SaveAllCommand(IBaritone hypervision) {
        super(hypervision, "saveall");
    }
    ...
    public String getShortDesc() {
        return "Saves hypervision's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The saveall command saves hypervision's world cache.",
                "",
                "Usage:",
                "> saveall"
        );
