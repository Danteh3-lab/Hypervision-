...
import hypervision.api.pathing.goals.GoalStrictDirection;
...
public class TunnelCommand extends Command {
    ...
    public TunnelCommand(IBaritone hypervision) {
        super(hypervision, "tunnel");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (args.hasExactly(3)) {
            ...
            if (cont) {
                ...
                hypervision.getBuilderProcess().clearArea(corner1, corner2);
            }
        } else {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The tunnel command sets a goal that tells hypervision to mine completely straight in the direction that you're facing.",
                "",
                "Usage:",
