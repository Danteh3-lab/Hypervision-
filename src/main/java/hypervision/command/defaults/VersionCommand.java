...
public class VersionCommand extends Command {
    ...
    public VersionCommand(IBaritone hypervision) {
        super(hypervision, "version");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (version == null) {
            ...
            logDirect(String.format("You are running hypervision v%s", version));
        }
    }
    ...
    public String getShortDesc() {
        return "View the hypervision version";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The version command prints the version of hypervision you're currently running.",
                "",
                "Usage:",
