...
public class ComeCommand extends Command {
    ...
    public ComeCommand(IBaritone hypervision) {
        super(hypervision, "come");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        hypervision.getCustomGoalProcess().setGoalAndPath(new GoalBlock(ctx.viewerPos()));
        logDirect("Coming");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The come command tells hypervision to head towards your camera.",
                "",
