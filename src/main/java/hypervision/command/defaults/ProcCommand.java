...
public class ProcCommand extends Command {
    ...
    public ProcCommand(IBaritone hypervision) {
        super(hypervision, "proc");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        IPathingControlManager pathingControlManager = hypervision.getPathingControlManager();
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The proc command provides miscellaneous information about the process currently controlling hypervision.",
                "",
                "You are not expected to understand this if you aren't familiar with how hypervision works.",
                "",
                "Usage:",
