...
public class ReloadAllCommand extends Command {
    ...
    public ReloadAllCommand(IBaritone hypervision) {
        super(hypervision, "reloadall");
    }
    ...
    public String getShortDesc() {
        return "Reloads hypervision's cache for this world";
    }

    @Override
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The reloadall command reloads hypervision's world cache.",
                "",
                "Usage:",
                "> reloadall"
        );
