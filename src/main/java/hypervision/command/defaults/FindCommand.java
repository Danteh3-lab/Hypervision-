...
import hypervision.api.command.datatypes.BlockById;
...
public class FindCommand extends Command {
    ...
    public FindCommand(IBaritone hypervision) {
        super(hypervision, "find");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The find command searches through hypervision's cache and attempts to find the location of the block.",
