...
public class MineCommand extends Command {
    ...
    public MineCommand(IBaritone hypervision) {
        super(hypervision, "mine");
    }
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        HypervisionAPI.getProvider().getWorldScanner().repack(ctx);
        logDirect(String.format("Mining %s", boms.toString()));
        hypervision.getMineProcess().mine(quantity, boms.toArray(new BlockOptionalMeta[0]));
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The mine command allows you to tell hypervision to search for and mine individual blocks.",
                "",
