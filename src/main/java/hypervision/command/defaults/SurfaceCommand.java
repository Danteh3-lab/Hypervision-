...
public class SurfaceCommand extends Command {
    ...
    protected SurfaceCommand(IBaritone hypervision) {
        super(hypervision, "surface", "top");
    }
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                "The surface/top command tells hypervision to head towards the closest surface-like area.",
                "",
