...
public class RepackCommand extends Command {
    ...
    public RepackCommand(IBaritone hypervision) {
        super(hypervision, "repack", "rescan");
    }

    @Override
    public void execute(String label, IArgConsumer args) throws CommandException {
        args.requireMax(0);
        logDirect(String.format("Queued %d chunks for repacking", HypervisionAPI.getProvider().getWorldScanner().repack(ctx)));
    }
