...
public class GuiClick extends Screen implements Helper {
    ...
    public GuiClick() {
        super(Component.literal("HYPERVISION CLICK"));
    }
    ...
    public void onRender(PoseStack modelViewStack, Matrix4f projectionMatrix) {
        ...
        if (currentMouseOver != null) {
            ...
            PathRenderer.drawManySelectionBoxes(modelViewStack, e, Collections.singletonList(currentMouseOver), HYPERVISION_SLATE);
            if (clickStart != null && !clickStart.equals(currentMouseOver)) {
                BufferBuilder bufferBuilder = IRenderer.startLines(HYPERVISION_CRIMSON, Baritone.settings().pathRenderLineWidthPixels.value);
