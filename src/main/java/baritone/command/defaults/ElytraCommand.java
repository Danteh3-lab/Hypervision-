...
public class ElytraCommand extends Command {
    ...
    private void gatekeep() {
        ...
        if (detectOn2b2t()) {
            ...
            if (Baritone.settings().elytraNetherSeed.value == NEW_2B2T_SEED) {
                MutableComponent gatekeep5 = Component.literal("Hypervision doesn't know the seed of your world. Set it with: " + Baritone.settings().prefix.value + "set elytraNetherSeed seedgoeshere\n");
                ...
                if (Baritone.settings().elytraPredictTerrain.value) {
                    MutableComponent gatekeep5 = Component.literal("Hypervision Elytra is predicting terrain assuming that " + Baritone.settings().elytraNetherSeed.value + " is the correct seed. Change that with " + Baritone.settings().prefix.value + "set elytraNetherSeed seedgoeshere, or disable it with " + Baritone.settings().prefix.value + "set elytraPredictTerrain false");
                    gatekeep.append(gatekeep5);
                } else {
